# Upstream Skills Manifest

Skills in `skills/` are original work by [@jecanore](https://github.com/jecanore) — MIT licensed.

Upstream skills below are NOT included in this repo. Install them directly from their source.
...
|---|---|---|
| `brand-voice-enforcement` | [anthropics/knowledge-work-plugins](https://github.com/anthropics/knowledge-work-plugins) | `npx skills add anthropics/knowledge-work-plugins@brand-voice-enforcement` |
| `ux-copy` | [anthropics/knowledge-work-plugins](https://github.com/anthropics/knowledge-work-plugins) | `npx skills add anthropics/knowledge-work-plugins@ux-copy` |
| `email-best-practices` | [resend/email-best-practices](https://github.com/resend/email-best-practices) | `npx skills add resend/email-best-practices@email-best-practices` |
| `wcag-audit-patterns` | [wshobson/agents](https://github.com/wshobson/agents) | `npx skills add wshobson/agents@wcag-audit-patterns` |
